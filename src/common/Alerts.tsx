...
export function WarningAlert({
  ...
  return (
    <div
      ...
      className={`relative w-full rounded-lg border border-yellow-200 bg-yellow-50 text-yellow-900 shadow-sm ${className}`}
    >
      <div className="flex items-start gap-3 p-4">
        {/* Icon */}
        <div className="mt-0.5">
        ...
        <button
          type="button"
          onClick={handleClose}
          className="rounded-md p-1 text-yellow-700 hover:bg-yellow-100 focus:outline-none focus:ring-2 focus:ring-yellow-500"
          aria-label="Dismiss alert"
        >
          <svg className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
            <path
