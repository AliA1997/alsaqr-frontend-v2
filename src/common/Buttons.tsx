...
export const CommonBoxButton = React.memo(function ({ buttonText, disabled, submitting, testId }: React.PropsWithChildren<CommonBoxButtonProps>) {
    return (
        <button
            ...
            className={`
                ...
                text-sm lg:text-xl font-bold text-white cursor-pointer 
                disabled:opacity-40
            `}
            type="submit"
        >
