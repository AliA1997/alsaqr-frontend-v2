...
export function PageTitleNoPadding({ children, classNames } : React.PropsWithChildren<any>){
    return (
        <h2 className={`
            bg-gray-50 sticky top-0 z-[999] p-0 pb-0 text-xl dark:bg-[#0e1517] dark:text-gray-50 font-bold ${classNames ? classNames : ''}
        `}>
            {children}
        </h2>
    );
